...
import {
  ...
  IconChartArcs3,
  IconListTree,
  // SmartPOS jump-link icon (full nav lives in SmartPosMenuItems.ts).
  IconBuildingStore,
...
const Menuitems: MenuitemsType[] = [
  ...
  // ============================================================
  // SmartPOS — single jump-link only. Once the user lands under
  // /smartpos/*, SidebarItems.tsx swaps to SmartPosMenuItems.ts
  // which has the full module navigation. Avoids duplicated edits.
  // ============================================================
  { navlabel: true, subheader: 'SmartPOS' },
  {
    id: uniqueId(),
    title: 'Open SmartPOS',
    icon: IconBuildingStore,
    href: '/smartpos/dashboard',
    chip: 'POS',
    chipColor: 'secondary',
  },
  {
