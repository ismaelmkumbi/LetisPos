...
const Router = [
  ...
  // ---- SmartPOS (protected) ----
  {
    ...
    children: [
      ...
      { path: 'reports', element: <FeatureGate feature="report.sales"><SmartPosReportsHub /></FeatureGate> },
      ...
      { path: 'reports/tax', element: <FeatureGate feature="report.financial"><SmartPosTaxReport /></FeatureGate> },
      { path: 'reports/purchases', element: <FeatureGate feature="report.sales"><SmartPosPurchaseReport /></FeatureGate> },
      { path: 'reports/payments', element: <FeatureGate feature="report.sales"><SmartPosPaymentReport /></FeatureGate> },
      { path: 'reports/customers', element: <FeatureGate feature="report.sales"><SmartPosCustomerReport /></FeatureGate> },
      { path: 'reports/suppliers', element: <FeatureGate feature="report.sales"><SmartPosSupplierReport /></FeatureGate> },
      { path: 'reports/financial', element: <FeatureGate feature="report.financial"><SmartPosFinancialReport /></FeatureGate> },
      { path: 'reports/employees', element: <FeatureGate feature="report.sales"><SmartPosEmployeeReport /></FeatureGate> },
      { path: 'reports/operations', element: <FeatureGate feature="report.sales"><SmartPosOperationsReport /></FeatureGate> },
