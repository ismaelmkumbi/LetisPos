...
const Router = [
  ...
  // ---- SmartPOS (protected) ----
  {
    ...
    children: [
      ...
      // Accounting
      { path: 'accounting/chart-of-accounts', element: <PlanGate minPlan="BUSINESS" featureName="Chart of Accounts"><SmartPosCoa /></PlanGate> },
      { path: 'accounting/journal-entries', element: <PlanGate minPlan="BUSINESS" featureName="Journal Entries"><SmartPosJournals /></PlanGate> },
      { path: 'accounting/ledger', element: <PlanGate minPlan="BUSINESS" featureName="General Ledger"><SmartPosAccountLedger /></PlanGate> },
      { path: 'accounting/financials', element: <PlanGate minPlan="BUSINESS" featureName="Financial Statements"><SmartPosFinancials /></PlanGate> },
      { path: 'taxes', element: <PlanGate minPlan="BUSINESS" featureName="Taxes"><SmartPosTaxes /></PlanGate> },
      // HRM
      ...
      { path: 'quotations', element: <PlanGate minPlan="BUSINESS" featureName="Quotations"><SmartPosQuotations /></PlanGate> },
      ...
      { path: 'expenses', element: <PlanGate minPlan="BUSINESS" featureName="Expenses"><SmartPosExpenses /></PlanGate> },
      ...
      { path: 'reports', element: <PlanGate minPlan="BUSINESS" featureName="Reports Hub"><SmartPosReportsHub /></PlanGate> },
      { path: 'reports/sales', element: <PlanGate minPlan="BUSINESS" featureName="Sales Reports"><SmartPosSalesReport /></PlanGate> },
      { path: 'reports/profit-loss', element: <PlanGate minPlan="BUSINESS" featureName="Profit & Loss"><SmartPosProfitLoss /></PlanGate> },
      { path: 'reports/inventory', element: <PlanGate minPlan="BUSINESS" featureName="Inventory Reports"><SmartPosInventoryReport /></PlanGate> },
      { path: 'reports/tax', element: <PlanGate minPlan="BUSINESS" featureName="Tax Reports"><SmartPosTaxReport /></PlanGate> },
      { path: 'reports/purchases', element: <PlanGate minPlan="BUSINESS" featureName="Purchase Reports"><SmartPosPurchaseReport /></PlanGate> },
      { path: 'reports/payments', element: <PlanGate minPlan="BUSINESS" featureName="Payment Reports"><SmartPosPaymentReport /></PlanGate> },
      { path: 'reports/customers', element: <PlanGate minPlan="BUSINESS" featureName="Customer Reports"><SmartPosCustomerReport /></PlanGate> },
      { path: 'reports/suppliers', element: <PlanGate minPlan="BUSINESS" featureName="Supplier Reports"><SmartPosSupplierReport /></PlanGate> },
      { path: 'reports/financial', element: <PlanGate minPlan="BUSINESS" featureName="Financial Reports"><SmartPosFinancialReport /></PlanGate> },
      { path: 'reports/employees', element: <PlanGate minPlan="BUSINESS" featureName="Employee Reports"><SmartPosEmployeeReport /></PlanGate> },
      { path: 'reports/operations', element: <PlanGate minPlan="BUSINESS" featureName="Operations Report"><SmartPosOperationsReport /></PlanGate> },
      { path: 'reports/schedules', element: <PlanGate minPlan="BUSINESS" featureName="Report Schedules"><SmartPosReportSchedules /></PlanGate> },
      { path: 'reports/builder', element: <PlanGate minPlan="BUSINESS" featureName="Report Builder"><SmartPosReportBuilder /></PlanGate> },
      { path: 'reports/exports', element: <PlanGate minPlan="BUSINESS" featureName="Export Center"><SmartPosReports /></PlanGate> },
      // Settings
      ...
      commerceAdminRoutes,
      // Marketing
      { path: 'marketing/promotions', element: <PlanGate minPlan="BUSINESS" featureName="Promotions"><SmartPosPromotions /></PlanGate> },
      { path: 'marketing/coupons', element: <PlanGate minPlan="BUSINESS" featureName="Coupons"><SmartPosCoupons /></PlanGate> },
      { path: 'marketing/sms-campaigns', element: <PlanGate minPlan="BUSINESS" featureName="SMS Campaigns"><SmartPosSmsCampaigns /></PlanGate> },
      { path: 'marketing/email-campaigns', element: <PlanGate minPlan="BUSINESS" featureName="Email Campaigns"><SmartPosEmailCampaigns /></PlanGate> },
      { path: 'marketing/whatsapp-campaigns', element: <PlanGate minPlan="BUSINESS" featureName="WhatsApp Campaigns"><SmartPosWhatsAppCampaigns /></PlanGate> },
      // Support
