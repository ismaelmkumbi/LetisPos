...
import { listSupplierPayments } from 'src/api/smartpos/payments';
import { listSuppliers } from 'src/api/smartpos/suppliers';
import type { Supplier, SupplierPayment } from 'src/api/smartpos/types';
