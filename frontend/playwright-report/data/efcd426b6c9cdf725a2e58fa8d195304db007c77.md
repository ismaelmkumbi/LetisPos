...
- Name: reports.spec.ts >> New Report Pages >> TC-REP-013: Report Schedules loads
- Location: tests/reports.spec.ts:80:3
...
Locator: getByRole('heading', { name: 'Report Schedules' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Report Schedules' })
