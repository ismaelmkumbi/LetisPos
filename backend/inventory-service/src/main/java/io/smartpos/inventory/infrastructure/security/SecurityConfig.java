package io.smartpos.inventory.infrastructure.security;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(r -> r
                        // CORS preflight must bypass auth — browsers send OPTIONS
                        // without an Authorization header before the real request.
