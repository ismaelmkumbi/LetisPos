...
INSERT INTO plan_definitions (id, code, label, description, monthly_price_tzs, annual_price_tzs, max_users, max_stores, max_products, features, sort_order) VALUES
  (gen_random_uuid(), 'FREE', 'Free', 'Trial fallback — limited access', 0, 0, 1, 1, 100, '{"accounting":false,"purchases":false,"reports":"basic","hrm":false,"crm":false,"api":false,"multi_currency":false,"multi_company":false,"white_label":false,"branches":false,"marketing":false,"audit":false,"support":"none"}', 0),
