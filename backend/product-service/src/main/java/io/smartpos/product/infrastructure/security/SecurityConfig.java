package io.smartpos.product.infrastructure.security;
 ...
 * Same permission-claim model as User Service — see that class for details.
 */
@Configuration
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(r -> r
                        // Browsers preflight every cross-origin request without an
                        // Authorization header — must always be allowed through.
